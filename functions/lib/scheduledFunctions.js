...
exports.triggerMonthlyReset = exports.checkSubscriptionExpiry = exports.dailySecurityScan = exports.weeklyCleanup = exports.monthlyReset = void 0;
 ...
 */
exports.monthlyReset = functions.pubsub.schedule('0 0 1 * *').timeZone('UTC').onRun(async (context) => {
    try {
        ...
        // Log the error
        await (0, audit_1.logSecurityEvent)({
 ...
 */
exports.weeklyCleanup = functions.pubsub.schedule('0 2 * * 0').timeZone('UTC').onRun(async (context) => {
    try {
        ...
        if (!oldTransactionsSnapshot.empty) {
            ...
            for (const doc of oldTransactionsSnapshot.docs) {
                ...
                batch.set(archiveRef, Object.assign(Object.assign({}, doc.data()), { archivedAt: admin.firestore.FieldValue.serverTimestamp() }));
                batch.delete(doc.ref);
            }
            await batch.commit();
 ...
 */
exports.dailySecurityScan = functions.pubsub.schedule('0 3 * * *').timeZone('UTC').onRun(async (context) => {
    try {
 ...
 */
exports.checkSubscriptionExpiry = functions.pubsub.schedule('0 1 * * *').timeZone('UTC').onRun(async (context) => {
    try {
